...
import ProjectOutsourcingImg from "../../assets/img/services/ProjectOutsourcimng.jpg"

function ProjectOutsourcing() {
  return (
    <div>
        <div>
      <div className="row">
        ...
        <div className="col-lg-7 mx-auto justify-items-center">
          <div className="text-center">
            <img id="blog-image" className="img-fluid mb-2" alt="Blog Image" src={ProjectOutsourcingImg}/>
          </div>
