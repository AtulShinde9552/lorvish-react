! function(e, t) {
    ...
    ! function(e) {
        ...
        h = null, String.prototype.startsWith || (a = function() {
            try {
                var e = {},
        ...
        function w(e, t, i, s) {
            for (var n = ["display", "subtext", "tokens"], o = !1, l = 0; l < n.length; l++) {
                var r = n[l],
                    a = e[r];
                if (a && (a = a.toString(), "display" === r && (a = a.replace(/<[^>]+>/g, "")), s && (a = S(a)), a = a.toUpperCase(), o = "contains" === i ? a.indexOf(t) >= 0 : a.startsWith(t))) break
            }
            return o
        }
        ...
        var E, C, O, z, L, T = (E = {
                ...
                return E[e]
            }, O = "(?:" + Object.keys(E).join("|") + ")", z = RegExp(O), L = RegExp(O, "g"), function(e) {
                return e = null == e ? "" : "" + e, z.test(e) ? e.replace(L, C) : e
            }),
            A = {
                32: " ",
                48: "0",
        ...
        function Y(i) {
            ...
            if ("4" === M.major) {
                var l = [];
                K.DEFAULTS.style === j.BUTTONCLASS && l.push({
                    name: "style",
                    className: "BUTTONCLASS"
                }), K.DEFAULTS.iconBase === j.ICONBASE && l.push({
                    name: "iconBase",
                    className: "ICONBASE"
                }), K.DEFAULTS.tickIcon === j.TICKICON && l.push({
                    name: "tickIcon",
                    className: "TICKICON"
            ...
            var a = this.each(function() {
                ...
                if (i.is("select")) {
                    ...
                    if (l) {
                        ...
                        var h = e.extend({}, K.DEFAULTS, e.fn.selectpicker.defaults || {}, c, r);
                        h.template = e.extend({}, K.DEFAULTS.template, e.fn.selectpicker.defaults ? e.fn.selectpicker.defaults.template : {}, c.template, r.template), i.data("selectpicker", l = new K(this, h))
                    }
        ...
        K.VERSION = "1.13.9", K.DEFAULTS = {
            ...
            init: function() {
                ...
                this.selectId = R++, this.$element[0].classList.add("bs-select-hidden"), this.multiple = this.$element.prop("multiple"), this.autofocus = this.$element.prop("autofocus"), this.options.showTick = this.$element[0].classList.contains("show-tick"), this.$newElement = this.createDropdown(), this.$element.after(this.$newElement).prependTo(this.$newElement), this.$button = this.$newElement.children("button"), this.$menu = this.$newElement.children(V.MENU), this.$menuInner = this.$menu.children(".inner"), this.$searchbox = this.$menu.find("input"), this.$element[0].classList.remove("bs-select-hidden"), !0 === this.options.dropdownAlignRight && this.$menu[0].classList.add(j.MENURIGHT), void 0 !== t && this.$button.attr("data-id", t), this.checkDisabled(), this.clickListener(), this.options.liveSearch && this.liveSearchListener(), this.setStyle(), this.render(), this.setWidth(), this.options.container ? this.selectPosition() : this.$element.on("hide.bs.select", function() {
                ...
                }), e.$element[0].hasAttribute("required") && this.$element.on("invalid.bs.select", function() {
                    ...
                    e.createLi(), e.$element.trigger("loaded.bs.select")
                })
            },
            ...
            setPlaceholder: function() {
                ...
                if (this.options.title && !this.multiple) {
                    ...
                    if (n) this.selectpicker.view.titleOption.className = "bs-title-option", this.selectpicker.view.titleOption.value = "", s = void 0 === e(i.options[i.selectedIndex]).attr("selected") && void 0 === this.$element.data("selected");
                    (n || 0 !== this.selectpicker.view.titleOption.index) && i.insertBefore(this.selectpicker.view.titleOption, i.firstChild), s && (i.selectedIndex = 0)
                }
                return t
            },
            createLi: function() {
                ...
                this.options.hideDisabled && (i += ":not(:disabled)"), !e.options.showTick && !e.multiple || F.checkMark.parentNode || (F.checkMark.className = t + " " + e.options.tickIcon + " check-mark", F.a.appendChild(F.checkMark));
                var a = this.$element[0].querySelectorAll("select > *" + i);

                function c(e) {
                    var t = n[n.length - 1];
                    t && "divider" === t.type && (t.optID || e.optID) || ((e = e || {}).type = "divider", s.push(G.li(!1, j.DIVIDER, e.optID ? e.optID + "div" : void 0)), n.push(e))
                }
                ...
                function d(i, l) {
                    if ((l = l || {}).divider = "true" === i.getAttribute("data-divider"), l.divider) c({
                        ...
                        var p = G.text(l);
                        s.push(G.li(G.a(p, h, d), "", l.optID)), i.liIndex = r, l.display = l.content || l.text, l.type = "option", l.index = r, l.option = i, l.disabled = l.disabled || i.disabled, n.push(l);
                        var u = 0;
                ...
                function h(e, o) {
                    ...
                    if (p.length) {
                        ...
                        var g = G.label(m);
                        s.push(G.li(g, "dropdown-header" + v, l)), n.push({
                            display: m.label,
                            subtext: m.subtext,
                            type: "optgroup-label",
                            optID: l
            ...
            render: function() {
                this.setPlaceholder();
                var e, t, i = this.$element[0].selectedOptions,
                    s = i.length,
                    n = this.$button[0],
                    ...
                    c = !1;
                if (this.togglePlaceholder(), this.tabIndex(), "static" === this.options.selectedTextFormat) a = G.text({
                    ...
                    for (var d = 0; d < s && d < 50; d++) {
                        ...
                        this.multiple && d > 0 && a.appendChild(l.cloneNode(!1)), h.title ? p.text = h.title : u.content && this.options.showContent ? (p.content = u.content.toString(), c = !0) : (this.options.showIcon && (p.icon = u.icon, p.iconBase = this.options.iconBase), this.options.showSubtext && !this.multiple && u.subtext && (p.subtext = " " + u.subtext), p.text = h.textContent.trim()), a.appendChild(G.text(p, !0))
                    }
                    s > 49 && a.appendChild(document.createTextNode("..."))
                } else {
                ...
                if (null == this.options.title && (this.options.title = this.$element.attr("title")), a.childNodes.length || (a = G.text({
                        text: void 0 !== this.options.title ? this.options.title : this.options.noneSelectedText
                    }, !0)), n.title = a.textContent.replace(/<[^>]*>?/g, "").trim(), this.options.sanitize && c && r([a], this.options.whiteList, this.options.sanitizeFn), o.innerHTML = "", o.appendChild(a), M.major < 4 && this.$newElement[0].classList.contains("bs3-has-addon")) {
                    var g = n.querySelector(".filter-expand"),
                        b = o.cloneNode(!0);
            ...
            liHeight: function(t) {
                if (t || !1 !== this.options.size && !this.sizeInfo) {
                    ...
                    var g, b = a.offsetHeight,
                        ...
                        O = E ? null : e(s),
                        z = {
                            vert: x(E ? E.paddingTop : O.css("paddingTop")) + x(E ? E.paddingBottom : O.css("paddingBottom")) + x(E ? E.borderTopWidth : O.css("borderTopWidth")) + x(E ? E.borderBottomWidth : O.css("borderBottomWidth")),
                            horiz: x(E ? E.paddingLeft : O.css("paddingLeft")) + x(E ? E.paddingRight : O.css("paddingRight")) + x(E ? E.borderLeftWidth : O.css("borderLeftWidth")) + x(E ? E.borderRightWidth : O.css("borderRightWidth"))
                        },
                        L = {
                            vert: z.vert + x(E ? E.marginTop : O.css("marginTop")) + x(E ? E.marginBottom : O.css("marginBottom")) + 2,
                            horiz: z.horiz + x(E ? E.marginLeft : O.css("marginLeft")) + x(E ? E.marginRight : O.css("marginRight")) + 2
                        };
            ...
            setSize: function(t) {
                if (this.liHeight(t), this.options.header && this.$menu.css("padding-top", 0), !1 !== this.options.size) {
                    ...
                    if (this.setMenuSize(), this.options.liveSearch && this.$searchbox.off("input.setMenuSize propertychange.setMenuSize").on("input.setMenuSize propertychange.setMenuSize", function() {
                            ...
                            return s.setMenuSize()
                        }) : this.options.size && "auto" != this.options.size && this.selectpicker.current.elements.length > this.options.size && n.off("resize.bs.select." + this.selectId + ".setMenuSize scroll" + U + "." + this.selectId + ".setMenuSize"), t) o = this.$menuInner[0].scrollTop;
                    else if (!s.multiple) {
                        var l = s.$element[0];
                        "number" == typeof(i = (l.options[l.selectedIndex] || {}).liIndex) && !1 !== s.options.size && (o = (o = s.sizeInfo.liHeight * i) - s.sizeInfo.menuInnerHeight / 2 + s.sizeInfo.liHeight / 2)
                    }
                    s.createView(!1, o)
                }
            },
            ...
            selectPosition: function() {
                ...
                var t, i, s, n = this,
                    ...
                    l = function(l) {
                        ...
                        n.$bsContainer.addClass(l.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(j.DROPUP, l.hasClass(j.DROPUP)), t = l.offset(), o.is("body") ? i = {
                            top: 0,
                            left: 0
                        } : ((i = o.offset()).top += parseInt(o.css("borderTopWidth")) - o.scrollTop(), i.left += parseInt(o.css("borderLeftWidth")) - o.scrollLeft()), s = l.hasClass(j.DROPUP) ? 0 : l[0].offsetHeight, (M.major < 4 || "static" === a) && (r.top = t.top - i.top + s, r.left = t.left - i.left), r.width = l[0].offsetWidth, n.$bsContainer.css(r)
                    };
                this.$button.on("click.bs.dropdown.data-api", function() {
                    n.isDisabled() || (l(n.$newElement), n.$bsContainer.appendTo(n.options.container).toggleClass(j.SHOW, !n.$button.hasClass(j.SHOW)).append(n.$menu))
                    ...
                    n.$newElement.hasClass(j.SHOW) && l(n.$newElement)
            ...
            setOptionStatus: function() {
                if (this.noScroll = !1, this.selectpicker.view.visibleElements && this.selectpicker.view.visibleElements.length)
                    for (var e = 0; e < this.selectpicker.view.visibleElements.length; e++) {
                        var t = this.selectpicker.current.data[e + this.selectpicker.view.position0],
                            i = t.option;
                        i && (this.setDisabled(t.index, t.disabled), this.setSelected(t.index, i.selected))
                    }
            },
            ...
            clickListener: function() {
                ...
                i.data("spaceSelect", !1), this.$button.on("keyup", function(e) {
                    ...
                    var n = e(this),
                        ...
                        d = !0;
                    if (t.multiple && 1 !== t.options.maxOptions && i.stopPropagation(), i.preventDefault(), !t.isDisabled() && !n.parent().hasClass(j.DISABLED)) {
                        var h = t.$element.find("option"),
                            ...
                            x = v.data("maxOptions") || !1;
                        if (r === t.activeIndex && (s = !0), s || (t.prevActiveIndex = t.activeIndex, t.activeIndex = void 0), t.multiple) {
                            if (p.selected = !f, t.setSelected(r, !f), n.trigger("blur"), !1 !== w || !1 !== x) {
                                var I = w < h.filter(":selected").length,
                                    k = x < v.find("option:selected").length;
                                if (w && I || x && k)
                                    if (w && 1 == w) {
                                        h.prop("selected", !1), u.prop("selected", !0);
                                        for (var $ = 0; $ < h.length; $++) t.setSelected($, !1);
                                        t.setSelected(r, !0)
                                    } else if (x && 1 == x) {
                                    v.find("option:selected").prop("selected", !1), u.prop("selected", !0);
                                    for ($ = 0; $ < b.length; $++) {
                                        p = b[$];
                                    ...
                                    var y = "string" == typeof t.options.maxOptionsText ? [t.options.maxOptionsText, t.options.maxOptionsText] : t.options.maxOptionsText,
                                        S = "function" == typeof y ? y(w, x) : y,
                                        E = S[0].replace("{n}", w),
                                        C = S[1].replace("{n}", x),
                                        O = e('<div class="notify"></div>');
                                    S[2] && (E = E.replace("{var}", S[2][w > 1 ? 0 : 1]), C = C.replace("{var}", S[2][x > 1 ? 0 : 1])), u.prop("selected", !1), t.$menu.append(O), w && I && (O.append(e("<div>" + E + "</div>")), d = !1, t.$element.trigger("maxReached.bs.select")), x && k && (O.append(e("<div>" + C + "</div>")), d = !1, t.$element.trigger("maxReachedGrp.bs.select")), setTimeout(function() {
                                        t.setSelected(r, !1)
                        ...
                        } else h.prop("selected", !1), p.selected = !0, t.setSelected(r, !0);
                        !t.multiple || t.multiple && 1 === t.options.maxOptions ? t.$button.trigger("focus") : t.options.liveSearch && t.$searchbox.trigger("focus"), d && (a != m(t.$element[0]) && t.multiple || c != t.$element.prop("selectedIndex") && !t.multiple) && (g = [p.index, u.prop("selected"), a], t.$element.triggerNative("change"))
                    }
                    ...
                    t.render(), t.$element.trigger("changed.bs.select", g), g = null
            ...
            val: function(e) {
                if (void 0 !== e) {
                    var t = m(this.$element[0]);
                    return g = [null, null, t], this.$element.val(e).trigger("changed.bs.select", g), this.render(), g = null, this.$element
                }
            ...
            changeAll: function(e) {
                if (this.multiple) {
                    ...
                    t.classList.remove("bs-select-hidden"), i !== s && (this.setOptionStatus(), this.togglePlaceholder(), g = [null, null, n], this.$element.triggerNative("change"))
                }
            },
            selectAll: function() {
            ...
            keydown: function(t) {
                var i, s, n, o, l, r = e(this),
                    ...
                    m = c.isVirtual(),
                    v = !0 === m ? c.selectpicker.view.position0 : 0;
                if (!(s = c.$newElement.hasClass(j.SHOW)) && (u || t.which >= 48 && t.which <= 57 || t.which >= 96 && t.which <= 105 || t.which >= 65 && t.which <= 90) && (c.$button.trigger("click.bs.dropdown.data-api"), c.options.liveSearch)) c.$searchbox.trigger("focus");
                else {
                    if (t.which === N && s && (t.preventDefault(), c.$button.trigger("click.bs.dropdown.data-api").trigger("focus")), u) {
                        if (!d.length) return;
                        ...
                        for (var k = 0; k < c.selectpicker.current.data.length; k++) {
                            var $ = c.selectpicker.current.data[k];
                            w($, x, "startsWith", !0) && c.selectpicker.view.canHighlight[k] && I.push($.index)
                        }
                        if (I.length) {
                            var y = 0;
                    ...
                    s && (t.which === H && !c.selectpicker.keydown.keyHistory || t.which === D || t.which === B && c.options.selectOnTab) && (t.which !== H && t.preventDefault(), c.options.liveSearch && t.which === H || (c.$menuInner.find(".active a").trigger("click", !0), r.trigger("focus"), c.options.liveSearch || (t.preventDefault(), e(document).data("spaceSelect", !0))))
                }
            },
            mobile: function() {
            ...
            refresh: function() {
                ...
                this.options = t, this.checkDisabled(), this.setStyle(), this.render(), this.createLi(), this.setWidth(), this.setSize(!0), this.$element.trigger("refreshed.bs.select")
            },
            hide: function() {
            ...
            destroy: function() {
                this.$newElement.before(this.$element).remove(), this.$bsContainer ? this.$bsContainer.remove() : this.$menu.remove(), this.$element.off(U).removeData("selectpicker").removeClass("bs-select-hidden selectpicker"), e(window).off(".bs.select." + this.selectId)
            }
        };
        var Z = e.fn.selectpicker;
        e.fn.selectpicker = Y, e.fn.selectpicker.Constructor = K, e.fn.selectpicker.noConflict = function() {
            return e.fn.selectpicker = Z, this
